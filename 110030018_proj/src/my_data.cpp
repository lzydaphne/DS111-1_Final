...
void my_data::merge(LNode *&arr, int p, int q, int r)
{
    // Create L ← A[p..q] and M ← A[q+1..r]
    int n1 = q - p + 1;
    int n2 = r - q;

    LNode *L = new LNode[n1];
    LNode *M = new LNode[n2];
...
void my_data::mergeSort(LNode *&arr, int l, int r)
{
    if (l < r)
    {
        // m is the point where the array is divided into two subarrays
...
void my_data::merge(cUNode *&arr, int p, int q, int r)
{
    // Create L ← A[p..q] and M ← A[q+1..r]
    int n1 = q - p + 1;
    int n2 = r - q;

    cUNode *L = new cUNode[n1];
    cUNode *M = new cUNode[n2];
...
void my_data::mergeSort(cUNode *&arr, int l, int r)
{
    if (l < r)
    {
        // m is the point where the array is divided into two subarrays
